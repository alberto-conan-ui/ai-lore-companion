...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-phase.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
[`add-stage`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-stage.verb.md) the level above ·
[`complete-phase`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-phase.verb.md) closes it ·
