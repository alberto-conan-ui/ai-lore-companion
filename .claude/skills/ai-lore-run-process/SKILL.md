...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/run-process.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- NOT for improvising a sequence that has no process — that is just invoking verbs
  in turn; and if the sequence recurs, [`add-process`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-process.verb.md) it.
...
[`add-process`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-process.verb.md) authors what this drives ·
core journeys: [`groom`](../../../.ai-lore-ai-lore-companion/memory/blueprint/processes/core/groom.process.md) ·
[`close-out`](../../../.ai-lore-ai-lore-companion/memory/blueprint/processes/core/close-out.process.md) ·
[`start-work`](../../../.ai-lore-ai-lore-companion/memory/blueprint/processes/core/start-work.process.md) ·
[`parallel-work`](../../../.ai-lore-ai-lore-companion/memory/blueprint/processes/core/parallel-work.process.md) ·
[`recover-session`](../../../.ai-lore-ai-lore-companion/memory/blueprint/processes/core/recover-session.process.md).
