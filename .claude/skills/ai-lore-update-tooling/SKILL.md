...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/update-tooling.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
[`add-tooling`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-tooling.verb.md)'s encyclopedia.
...
- A session followed the card and hit a mismatch — fix the card in the same breath
  as the discovery (or [`add-note`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/add-note.verb.md) it when mid-flight).
...
[`add-tooling`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-tooling.verb.md) · [`retire-tooling`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/retire-tooling.verb.md).
