...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-contract.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- A note routed by [`integrate-notepad`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/integrate-notepad.verb.md) turns out to
  be a rule.
...
then what checks it (a hook, a walk at [`save-point`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/acknowledgement/save-point.verb.md), a
reviewer's eye).
...
same motion ([`update-verb`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/update-verb.verb.md) / `update-process`), and the
...
[`update-contract`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/update-contract.verb.md) ·
[`retire-contract`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/retire-contract.verb.md) ·
[`save-point`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/acknowledgement/save-point.verb.md) walks the accumulated set ·
[`integrate-notepad`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/integrate-notepad.verb.md) feeds rules here.
