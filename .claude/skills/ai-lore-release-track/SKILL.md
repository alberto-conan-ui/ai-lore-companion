...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/release-track.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
[`mount-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/mount-track.verb.md) refuses stale mounts and points here ·
[`orient`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/bookends/orient.verb.md) surfaces the drift the dead session left ·
[`ack`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/acknowledgement/ack.verb.md) acknowledges it once understood ·
[`abandon-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/abandon-track.verb.md) if the whole track turns out to be dead
with its session.
