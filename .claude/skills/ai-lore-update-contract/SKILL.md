...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/update-contract.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
is theirs to move. Inherits [`add-contract`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-contract.verb.md)'s encyclopedia.
...
[`add-contract`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-contract.verb.md) · [`retire-contract`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/retire-contract.verb.md).
