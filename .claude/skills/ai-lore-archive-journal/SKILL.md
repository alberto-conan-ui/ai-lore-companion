...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/lifecycle/archive-journal.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
[`close-session`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/bookends/close-session.verb.md) writes what this eventually rolls ·
[`save-point`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/acknowledgement/save-point.verb.md) entries outlive every roll by design ·
