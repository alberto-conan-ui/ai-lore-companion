...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/merge-track.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- NOT for discarding (that is [`abandon-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/abandon-track.verb.md)) and never
...
then note the violation ([`add-note`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/add-note.verb.md)) because the discipline
leaked.
...
7. **State what landed** — and whether a
   [`save-point`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/acknowledgement/save-point.verb.md) is now warranted (it often is; last child
   closed unlocks it).
...
[`abandon-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/abandon-track.verb.md) the discarding exit ·
[`spawn-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/spawn-track.verb.md) the entry ·
[`ack`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/acknowledgement/ack.verb.md) cleans the child first ·
[`save-point`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/acknowledgement/save-point.verb.md) consolidates after.
