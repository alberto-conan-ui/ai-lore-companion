...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-new-focus.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- NOT for adding work *under* an existing focus — that is [`add-stage`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-stage.verb.md)
  / [`add-phase`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-phase.verb.md).

## What this creates

Everything a focus *is* — shape rules, focus types and gates, claims, lifecycle,
file shapes, naming, decompose-late — lives in [`status-tree.md`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/status-tree.md);
...
[`update-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/update-focus.verb.md) amends the body ·
[`add-stage`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-stage.verb.md) decomposes ·
[`pause-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/pause-focus.verb.md) / [`resume-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/resume-focus.verb.md)
side-state · [`complete-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-focus.verb.md) the Done call ·
[`archive-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/archive-focus.verb.md) relocates the finished subtree ·
[`review-focus-tree`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/review-focus-tree.verb.md) challenges what lingers ·
[`review-backlog`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/review-backlog.verb.md) proposes graduations.
