...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/processes/core/groom.process.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this process makes is confirmed with the Human Lead.
...
[`ack`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/acknowledgement/ack.verb.md) is the natural coda — and if the journal's live window
has grown stale, offer [`archive-journal`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/lifecycle/archive-journal.verb.md) as an
encore.
