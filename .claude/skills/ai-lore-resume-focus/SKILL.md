...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/resume-focus.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- NOT for starting a `draft` focus — `draft → in progress` happens automatically on
  first work (stated in [`add-new-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-new-focus.verb.md) and
  [`mount-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/mount-track.verb.md)); there is no resume ceremony for a focus
  that never started.
...
[`update-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/update-focus.verb.md) (Human Lead confirming) before work
...
[`update-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/update-track.verb.md).
...
[`pause-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/pause-focus.verb.md) the way out ·
[`update-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/update-focus.verb.md) amends the stale gate ·
[`review-focus-tree`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/review-focus-tree.verb.md) proposes which pauses deserve
resuming at all.
