...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/remove-parent.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
[`add-parent`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/add-parent.verb.md)'s encyclopedia.

## When to invoke

- The upstream is dead, diverged, or the relationship ended.
- NOT to dodge one inherited artifact — shadow that one name instead
  ([`add-verb`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-verb.verb.md) / [`add-contract`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-contract.verb.md));
...
[`add-parent`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/add-parent.verb.md) the encyclopedia ·
[`review-references`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/review-references.verb.md) proposes removals ·
[`install`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/lifecycle/install.verb.md) re-projects.
