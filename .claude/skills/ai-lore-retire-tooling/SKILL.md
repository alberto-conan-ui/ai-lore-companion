...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/retire-tooling.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
[`add-tooling`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-tooling.verb.md) · [`update-tooling`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/update-tooling.verb.md).
