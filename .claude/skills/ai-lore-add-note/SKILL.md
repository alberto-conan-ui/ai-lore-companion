...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/add-note.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- NOT for work items ("we should build…") — that is
  [`add-backlog-item`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/add-backlog-item.verb.md). Notes are *knowledge*; backlog
...
[`buffers.md`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/buffers.md). This card's whole discipline: capture with enough
...
[`integrate-notepad`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/integrate-notepad.verb.md) drains and routes ·
[`add-backlog-item`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/add-backlog-item.verb.md) the work-item sibling ·
[`close-session`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/bookends/close-session.verb.md) journals the session that noted.
