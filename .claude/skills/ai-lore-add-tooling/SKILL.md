...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-tooling.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- NOT for the executable itself — **the tool lives in the Payload** (written via
  [`update-payload`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/payload/update-payload.verb.md) or a project verb); the registry is
...
- It's a hand-checklist → [`add-process`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-process.verb.md).

## Related

[`update-tooling`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/update-tooling.verb.md) ·
[`retire-tooling`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/retire-tooling.verb.md) ·
[`update-payload`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/payload/update-payload.verb.md) builds the tools this registers ·
[`integrate-notepad`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/integrate-notepad.verb.md) routes tool-discoveries here.
