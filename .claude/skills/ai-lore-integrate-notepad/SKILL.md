...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/integrate-notepad.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- NOT at capture time — routing during capture is exactly the friction
  [`add-note`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/add-note.verb.md) exists to avoid.
...
| Route | Through |
|---|---|
| It's an inviolable rule | [`add-contract`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-contract.verb.md) (or `update-contract` when it sharpens one) |
| It describes the Payload's shape | [`update-mirror`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/update-mirror.verb.md) |
| It's an owned executable | [`add-tooling`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-tooling.verb.md) / `update-tooling` |
| It was work all along | [`add-backlog-item`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/add-backlog-item.verb.md) |
...
[`add-note`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/add-note.verb.md) fills · destinations:
[`add-contract`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-contract.verb.md) · [`update-mirror`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/update-mirror.verb.md)
· [`add-tooling`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-tooling.verb.md) ·
[`add-backlog-item`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/add-backlog-item.verb.md). Sibling groomer:
[`review-backlog`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/review-backlog.verb.md) — often chained (intake feeds the
...
[`integrate-notepad`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/integrate-notepad.verb.md), where every note leaves as a
...
[`add-new-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-new-focus.verb.md) absorbs the item and
removes it) or **death** ([`review-backlog`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/review-backlog.verb.md) kills what
no longer matters).
