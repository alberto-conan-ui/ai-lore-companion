...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-stage.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- NOT for the focus itself — a focus's Done call is the Human-Lead-only
  [`complete-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-focus.verb.md). A session **may** complete stages and
...
that turned out wrong is amended first via [`update-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/update-focus.verb.md)
...
[`complete-phase`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-phase.verb.md) the level below ·
[`add-stage`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-stage.verb.md) creates ·
[`complete-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-focus.verb.md) the focus-level Done call ·
[`review-focus-tree`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/review-focus-tree.verb.md) catches stages that sit half-done.
