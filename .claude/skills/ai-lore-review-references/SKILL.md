...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/review-references.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
3. **Interview** per finding; execute accepted outcomes through
   ...
   [`add-parent`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/add-parent.verb.md) / [`remove-parent`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/remove-parent.verb.md)
   / [`update-payload`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/payload/update-payload.verb.md)-adjacent repairs as fits.
...
[`add-reference`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/add-reference.verb.md) / [`remove-reference`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/remove-reference.verb.md)
· [`add-parent`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/add-parent.verb.md) / [`remove-parent`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/remove-parent.verb.md)
