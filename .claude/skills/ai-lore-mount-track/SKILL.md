...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/mount-track.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
Types, one-per rules, registration, claims: [`tracks.md`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/tracks.md). What this
...
3. **Verify mountable**: exists, and `mounted_by` is blank (a dead session's stale
   mount is [`release-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/release-track.verb.md)'s business — never steal).
...
[`spawn-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/spawn-track.verb.md) creates ·
[`release-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/release-track.verb.md) recovers stale mounts ·
[`update-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/update-track.verb.md) polishes the claim ·
[`orient`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/bookends/orient.verb.md) runs the same chain walk at session open ·
[`close-session`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/bookends/close-session.verb.md) unmounts.
