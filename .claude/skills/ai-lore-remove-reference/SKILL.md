...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/remove-reference.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
[`add-reference`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/add-reference.verb.md)'s encyclopedia.

## When to invoke

- The target moved away, died, or simply stopped mattering;
  [`review-references`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/review-references.verb.md) proposes these.
