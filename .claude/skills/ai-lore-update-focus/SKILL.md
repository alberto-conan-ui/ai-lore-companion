...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/update-focus.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- NOT for structure — creating, moving, or removing nodes is
  [`add-stage`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-stage.verb.md) / [`add-phase`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-phase.verb.md) /
  [`archive-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/archive-focus.verb.md) work. Never both in one act.
...
- A `status:` change → route to the lifecycle verbs
  ([`pause-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/pause-focus.verb.md), [`complete-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-focus.verb.md), …).

## Related

[`add-new-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-new-focus.verb.md) creates ·
[`add-stage`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-stage.verb.md) / [`add-phase`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-phase.verb.md) decompose ·
[`complete-stage`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-stage.verb.md) / [`complete-phase`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-phase.verb.md)
close children · [`review-focus-tree`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/review-focus-tree.verb.md) challenges staleness.
