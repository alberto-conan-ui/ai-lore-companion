...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/spawn-track.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- NOT to attach the current session (that is
  [`mount-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/mount-track.verb.md) — a different act, usually a different
  session) and NOT for a quick journal/backlog/notepad jot (a light track needs no
  spawn, no record, no branch).

## What spawn settles

The track primitive, types, claims, and lifecycle: [`tracks.md`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/tracks.md).
...
[`mount-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/mount-track.verb.md) attaches ·
...
end it · [`update-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/update-track.verb.md) reshapes the claim mid-life ·
[`save-point`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/acknowledgement/save-point.verb.md) refuses while children are open.
