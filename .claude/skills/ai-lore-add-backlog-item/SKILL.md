...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/add-backlog-item.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- NOT for knowledge (that is [`add-note`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/add-note.verb.md)) and NOT for work being
  committed to right now (that is [`add-new-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-new-focus.verb.md) — skip
  the buffer when commitment is already here).

## Where it lands

The backlog's shape, item schema, and the graduation/death exits:
[`buffers.md`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/buffers.md). This card's discipline: the item is self-contained
...
[`review-backlog`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/review-backlog.verb.md) polishes and graduates ·
[`add-new-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-new-focus.verb.md) the graduation target ·
[`add-note`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/add-note.verb.md) the knowledge sibling ·
[`integrate-notepad`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/integrate-notepad.verb.md) routes notes here when they were
work all along.
