...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/acknowledgement/ack-and-continue.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
The lightweight sibling of [`ack`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/acknowledgement/ack.verb.md): same commit shape, same pairing
...
- NOT when the Human Lead wants to pause and inspect (that is `ack`), and NOT for
  milestones (that is [`save-point`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/acknowledgement/save-point.verb.md)).
...
[`ack`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/acknowledgement/ack.verb.md) the deliberate sibling (and the encyclopedia for the pairing
mechanics — read it once; this verb inherits all of it) ·
[`save-point`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/acknowledgement/save-point.verb.md) the milestone ·
[`complete-phase`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-phase.verb.md) often precedes this verb.
