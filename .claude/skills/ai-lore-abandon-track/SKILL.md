...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/abandon-track.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
2. **Confirm the verb** (golden rule) and check nobody is mounted on the child (a
   ...
   [`release-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/release-track.verb.md)'d first).
...
[`merge-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/merge-track.verb.md) the landing exit ·
[`release-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/release-track.verb.md) clears a dead mount first ·
[`pause-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/pause-focus.verb.md) for the orphaned focus ·
[`spawn-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/spawn-track.verb.md) if the direction revives later.
