...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/retire-verb.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
[`add-verb`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-verb.verb.md)'s encyclopedia.
...
- NOT for core artifacts (core retires only via [`upgrade`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/lifecycle/upgrade.verb.md)
...
amended first ([`update-process`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/update-process.verb.md)). Then: file removed,
...
[`add-verb`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-verb.verb.md) · [`update-verb`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/update-verb.verb.md) ·
[`upgrade`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/lifecycle/upgrade.verb.md) the core-side lifecycle.
