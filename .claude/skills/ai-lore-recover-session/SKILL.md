...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/processes/core/recover-session.process.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this process makes is confirmed with the Human Lead.
