...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/update-track.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- Home's working claim needs polish independent of the focus's persistent default
  ...
  edit the right one: persistent → [`update-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/update-focus.verb.md), working
  → here).
...
- NOT for `mounted_by` — mounting state belongs to
  [`mount-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/mount-track.verb.md) / [`release-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/release-track.verb.md)
...
[`spawn-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/spawn-track.verb.md) sets the initial shape ·
[`update-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/update-focus.verb.md) edits the focus-side claim default ·
[`mount-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/mount-track.verb.md) seeds claims at attach ·
[`release-track`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/tracks/release-track.verb.md) the other maintenance verb.
