...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-process.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- NOT for a single operation (that is a verb —
  [`add-verb`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-verb.verb.md)) and NOT for a rule (that is
...
lowest wins ([`add-verb`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-verb.verb.md) carries the chain's encyclopedia).
...
[`update-process`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/update-process.verb.md) ·
[`retire-process`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/retire-process.verb.md) ·
[`add-verb`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-verb.verb.md) fills the gaps steps find ·
