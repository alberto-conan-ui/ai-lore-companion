...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-phase.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- NOT for stages or focuses — those are
  [`complete-stage`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-stage.verb.md) and the Human-Lead-only
  [`complete-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-focus.verb.md).
...
[`ack-and-continue`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/acknowledgement/ack-and-continue.verb.md) when a closed phase is a clean
commit chunk.
...
[`add-phase`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-phase.verb.md) creates ·
[`complete-stage`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-stage.verb.md) the level above ·
[`ack-and-continue`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/acknowledgement/ack-and-continue.verb.md) commits the chunk.
