...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/review-backlog.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- After [`integrate-notepad`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/integrate-notepad.verb.md) — intake feeds the
  backlog; polish follows naturally (the `groom` process chains them).
- NOT for capture (that is [`add-backlog-item`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/add-backlog-item.verb.md)) and NOT
...
- **Graduate** — the project commits now: route to
  [`add-new-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-new-focus.verb.md), which absorbs the item's content and
...
[`add-backlog-item`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/add-backlog-item.verb.md) fills ·
...
[`integrate-notepad`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/integrate-notepad.verb.md) the upstream inbox ·
[`review-focus-tree`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/review-focus-tree.verb.md) may send stale drafts back here.
