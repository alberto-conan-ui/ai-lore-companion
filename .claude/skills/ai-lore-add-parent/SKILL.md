...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/add-parent.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- A reference turns out to be inherited-from in spirit —
  [`review-references`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/review-references.verb.md) proposes the promotion.
- NOT for consult-only context — that is
  [`add-reference`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/add-reference.verb.md).

## What a parent is

Parents vs references, the resolution chain, the DAG: [`outward.md`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/outward.md)
and [`blueprint.md`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/blueprint.md). What this card adds: adding a
...
[`remove-parent`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/remove-parent.verb.md) ·
[`review-references`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/review-references.verb.md) audits the list ·
[`install`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/lifecycle/install.verb.md) projects the resolved set ·
[`upgrade`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/lifecycle/upgrade.verb.md) re-validates local shadows when *core* moves — the
...
- **Parents** — eager, inherited. An ordered `parents:` list in
  ...
  statement lives in [`blueprint.md`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/blueprint.md) and the floor).
...
([`review-references`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/review-references.verb.md)): a reference the project keeps
...
and written by exactly one verb: [`publish`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/publish.verb.md). The recipe —
