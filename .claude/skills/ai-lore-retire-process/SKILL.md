...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/retire-process.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
invoked.** Inherits [`add-process`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-process.verb.md)'s encyclopedia.

## When to invoke

- The ritual is no longer performed, or a shadow's reason dissolved (retiring it
  restores the inherited process).
- NOT for core (that is [`upgrade`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/lifecycle/upgrade.verb.md)'s replacement) and never for
  a floor artifact.
...
[`add-process`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-process.verb.md) · [`update-process`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/update-process.verb.md).
