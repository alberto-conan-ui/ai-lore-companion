...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/publish.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
[`add-process`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-process.verb.md)). This verb is the platform-neutral gate:
...
[`add-process`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/add-process.verb.md) authors the recipe ·
[`update-payload`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/payload/update-payload.verb.md) works the workshop ·
[`init`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/lifecycle/init.verb.md) sets the Publishing shape.
