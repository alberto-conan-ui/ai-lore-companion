...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-stage.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- NOT for a new unit of intent (that is [`add-new-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-new-focus.verb.md))
...
Shape rules, file shapes, naming: [`status-tree.md`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/status-tree.md). What this
...
[`add-phase`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/add-phase.verb.md) the level below ·
[`complete-stage`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-stage.verb.md) closes it ·
[`update-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/update-focus.verb.md) amends its body later ·
[`review-focus-tree`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/review-focus-tree.verb.md) challenges stages that linger.
