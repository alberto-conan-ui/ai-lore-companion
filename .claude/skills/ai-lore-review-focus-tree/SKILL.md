...
> Projected from `.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/review-focus-tree.verb.md` by `ai-lore.py install` — the Lore file is the source; this copy is derived. Under the golden rule every write this verb makes is confirmed with the Human Lead.
...
- **Overdue Done calls** — work shipped, focus still open. Classic tell: a `paused`
  ...
  is the known dishonesty). Proposal: [`complete-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-focus.verb.md).
...
- **Unarchived closures** — `done` focuses cluttering the live tree. Proposal:
  [`archive-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/archive-focus.verb.md) batch.
- **Pointer rot** — active-child pointers at closed children, stack rows disagreeing
  with frontmatter. Proposal: [`update-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/update-focus.verb.md) repairs.
...
Executes through: [`complete-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-focus.verb.md) ·
[`archive-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/archive-focus.verb.md) · [`pause-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/pause-focus.verb.md) /
[`resume-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/resume-focus.verb.md) · [`update-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/update-focus.verb.md).
Siblings in grooming: [`review-backlog`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/review-backlog.verb.md) ·
[`integrate-notepad`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/buffers/integrate-notepad.verb.md) ·
[`review-mirror`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/blueprint/review-mirror.verb.md) ·
[`review-references`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/outward/review-references.verb.md). Composed by the `groom` process.
...
Bodies (gate text, context prose) are [`update-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/update-focus.verb.md)'s;
...
[`pause-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/pause-focus.verb.md); **`done` is Human-Lead-only**
([`complete-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/complete-focus.verb.md)). Review is not a state — a focus
...
[`archive-focus`](../../../.ai-lore-ai-lore-companion/memory/blueprint/verbs/core/status-tree/archive-focus.verb.md) — relocation, never deletion; the stack
