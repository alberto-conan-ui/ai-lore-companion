...
- [dashboard-refresh.md](./dashboard-refresh.md): use to ask the PM for fresh typed dashboard data, in Read only.
- [dashboard-update.md](./dashboard-update.md): use to change the Space dashboard layout and content in its custom Lore definition, with the Lore claimed.
- [dashboard-reset.md](./dashboard-reset.md): use to restore the default dashboard by removing the custom definition, with the Lore claimed.
